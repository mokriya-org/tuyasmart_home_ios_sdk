...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/Base/Assets/customColor.plist"
  ...
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_add@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_add@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_index_custom@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_index_custom@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_index_scene_close@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_index_scene_close@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_active@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_add_action@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_add_action@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_custom2@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_custom2@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_error@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_error@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_gray@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_selected@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_selected@3x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_switch@2x.png"
  install_resource "${PODS_ROOT}/../../TuyaSmartDemo/Classes/SmartScene/Assets/ty_scene_switch@3x.png"
